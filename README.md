...
This project does not duplicate its siblings. [WorthSignal](https://github.com/UlrikErlingsen/customer-value-analytics) covers customer value, RFM targeting, CLV, retention, and marketing ROI; [ChoiceSignal](https://github.com/UlrikErlingsen/conjoint-analysis) covers conjoint analysis — what customers value in a product. [AdoptSignal](https://github.com/UlrikErlingsen/adoption-forecasting) forecasts when a new product gets adopted. [PositionSignal](https://github.com/UlrikErlingsen/brand-positioning) maps how brands are perceived against competitors. SegmentSignal focuses on multi-variable segment discovery, validation, profiling, and export. Regression predicts an outcome; clustering forms groups; conjoint measures preferences. They are different jobs.
